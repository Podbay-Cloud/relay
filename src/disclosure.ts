...
export const DISCLOSURE = `
  pb relay lets a Podbay pod fetch web pages THROUGH THIS MACHINE — from your network,
  ...
  What that means, plainly:
   ...
   • 'pb relay login <site>' is the one step that lets THAT site be fetched as you.
